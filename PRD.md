...
### FR-1: Multimodal Industrial Asset Ingestion (**Milestone 2 - COMPLETED**)
...
- ISA-5.1 equipment and valve tag extraction with OCR noise repair (`graph_builder.py`), KD-Tree geometric snapping, and dual NetworkX topological graph assembly (`nx.Graph` and `nx.DiGraph`).
